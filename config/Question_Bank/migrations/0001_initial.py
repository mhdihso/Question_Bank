...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type_qu', models.TextField(choices=[('1', 'Multi options'), ('2', 'Descriptive '), ('3', 'True or False'), ('4', 'blank')], max_length=1)),
                ...
                ('question_voice', models.FileField(blank=True, null=True, upload_to='Questions_voice')),
                ('answer_image', models.ImageField(blank=True, null=True, upload_to='Answer_img')),
                ('answer_voice', models.FileField(blank=True, null=True, upload_to='Answer_voice')),
